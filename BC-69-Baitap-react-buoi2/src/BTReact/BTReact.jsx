...
export const BTReact = () => {
  ...
  return (
    <Fragment>
      ...
      >
        <div
          className="absolute bottom-0 left-0 right-0 top-0 h-full w-full bg-fixed bg"
                ...
                {selectedGlasses && (
                  <Fragment>
                    <img
                      ...
                      className="absolute top-[5.75rem] left-[4.75rem] w-36 h-14"
                      style={{ mixBlendMode: "multiply" }}
                    />
                    <div
                      className="absolute bot-[0] left-0 transform -translate-y-[100%] bg-amber-100 bg-opacity-50 rounded shadow-lg"
                      style={{ width: "296px" }}
                    >
